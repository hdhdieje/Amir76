...
class HiRiseBot(BaseBot):
    ...
    def __init__(self):
        ...
        # ── پیام‌های قابل تنظیم ──
        self.welcome_text = "🎉 سلام {user}  <#FF0000> به مدرسه دولتی خوش آمدید <#FFFFFF> روی آواتار هم واینستید باهم مهربان باشید و بی احترامی نکنید ✨<#00FF00> برای زدن دنس عدد ۱ تا ۲۳۱ را تایپ کنید  📚📝 🤍"
        self.goodbye_text  = "👋 {user}  <#FF0000> به مدرسه دولتی خوش آمدید <#FFFFFF> روی آواتار هم واینستید باهم مهربان باشید و بی احترامی نکنید ✨<#00FF00> برای زدن دنس عدد ۱ تا ۲۳۱ را تایپ کنید 📚📝"
